...
```bash
curl -fsSL https://github.com/thagore-foundation/thagore/releases/download/v0.9.4/thagup-v0.9.4.sh | sh
```

```powershell
irm https://github.com/thagore-foundation/thagore/releases/download/v0.9.4/thagup-v0.9.4.ps1 | iex
```
