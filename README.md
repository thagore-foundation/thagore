...
```bash
curl -fsSL https://github.com/thagore-foundation/thagore/releases/download/v0.9.2/thagup-v0.9.2.sh | sh
```

```powershell
irm https://github.com/thagore-foundation/thagore/releases/download/v0.9.2/thagup-v0.9.2.ps1 | iex
```
