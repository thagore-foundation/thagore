...
```bash
curl -fsSL https://github.com/thagore-foundation/thagore/releases/download/v0.9.1/thagup-v0.9.1.sh | sh
```

```powershell
irm https://github.com/thagore-foundation/thagore/releases/download/v0.9.1/thagup-v0.9.1.ps1 | iex
```
