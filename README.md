...
```bash
curl -fsSL https://github.com/thagore-foundation/thagore/releases/download/v0.9.5/thagup-v0.9.5.sh | sh
```

```powershell
irm https://github.com/thagore-foundation/thagore/releases/download/v0.9.5/thagup-v0.9.5.ps1 | iex
```
