...
| --- | --- | --- |
| `print` | `print(s: str)` | write to stdout without newline |
| `println` | `println(s: str)` | write to stdout with newline |
| `eprint` | `eprint(s: str)` | write to stderr without newline |
| `eprintln` | `eprintln(s: str)` | write to stderr with newline |
