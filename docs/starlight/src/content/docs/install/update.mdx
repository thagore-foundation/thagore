...
```bash
thagore --version
# thagore 0.3.60-foundation (linux/x86_64)
```
...
```
thagore 0.3.60-foundation is up to date.
```

**Example output - update available:**
```
Update available: 0.3.60-foundation -> 0.3.61-foundation
...
```
Roll back from 0.3.61-foundation to 0.3.60-foundation? [Y/n]:
```
...
```
Notice: thagore 0.3.61-foundation is available. Run `thagore update apply` to install.
```
