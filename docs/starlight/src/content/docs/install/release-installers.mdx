...
```bash
curl -fsSL https://github.com/thagore-foundation/thagore/releases/download/v0.9.7/thagore-0.9.6-x86_64-unknown-linux-gnu.tar.gz -o thagore.tar.gz
curl -fsSL https://github.com/thagore-foundation/thagore/releases/download/v0.9.7/SHA256SUMS-v0.9.7.txt -o SHA256SUMS-v0.9.7.txt
sha256sum --check --ignore-missing SHA256SUMS-v0.9.7.txt
...
`indev` is the public release channel. As of v0.9.7 it is the stable channel; earlier versions were in active development.
