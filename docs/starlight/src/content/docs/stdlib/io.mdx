...
| --- | --- | --- |
| `print` | `func print(value: str)` | write to stdout without newline |
| `println` | `func println(value: str)` | write to stdout with newline |
...
| `eprint` | `func eprint(value: str)` | write to stderr without newline |
| `eprintln` | `func eprintln(value: str)` | write to stderr with newline |

For direct primitive output without importing `std.io`, prefer the built-in `print` / `println` functions.
...
func main():
  ...
  io.println(string.from_int(sum_items(items)))
```
