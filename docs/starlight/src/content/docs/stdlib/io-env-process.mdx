...
<Aside type="note" title="Minimal Implementation">
The current `map.tg` module provides deterministic contract entry points with a minimal surface. It is suitable for compatibility lanes and will be expanded in later iterations.
</Aside>
