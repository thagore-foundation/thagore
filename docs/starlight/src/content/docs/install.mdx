...
```bash
curl -fsSL https://raw.githubusercontent.com/thagore-foundation/thagore/main/tooling/release/thagup.sh | sh
```

### Install to a custom prefix

```bash
curl -fsSL https://raw.githubusercontent.com/thagore-foundation/thagore/main/tooling/release/thagup.sh | sh -s -- --prefix "$HOME/.thagore"
```

### Install a specific target or channel

```bash
curl -fsSL https://raw.githubusercontent.com/thagore-foundation/thagore/main/tooling/release/thagup.sh | sh -s -- \
  --channel extended \
...
```powershell
irm https://raw.githubusercontent.com/thagore-foundation/thagore/main/tooling/release/thagup.ps1 | iex
```
...
The current `drago` codebase expects `thagc >= 0.9.0`.
