...
- checks simple semantic issues like missing `main`, unknown callees, duplicate imports, duplicate imported symbols, unknown return identifiers, duplicate locals, duplicate funcs, and invalid imported symbols
