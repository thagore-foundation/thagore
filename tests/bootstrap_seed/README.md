...
- checks simple semantic issues like missing `main`, unknown callees, duplicate imports, unknown return identifiers, duplicate locals, duplicate funcs, and invalid imported symbols
