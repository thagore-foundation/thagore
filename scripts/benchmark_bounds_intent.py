...
NAIVE_SRC = ROOT / "examples" / "intent_real_bounds_naive.tg"
INTENT_SRC = ROOT / "examples" / "intent_real_bounds_intent.tg"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark bounds intent rewrites")
...
def main() -> int:
    ...
    naive_exe = ROOT / "intent_real_bounds_naive.exe"
    intent_exe = ROOT / "intent_real_bounds_intent.exe"
