...
NAIVE_SRC = ROOT / "examples" / "intent_real_ultra_pack_naive.tg"
INTENT_SRC = ROOT / "examples" / "intent_real_ultra_pack_intent.tg"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark ultra intent rewrite pack")
...
def main() -> int:
    ...
    naive_exe = ROOT / "intent_real_ultra_pack_naive.exe"
    intent_exe = ROOT / "intent_real_ultra_pack_intent.exe"
    ...
    print("=== Ultra Intent Pack Benchmark ===")
    print("unit: seconds")
    print("")
