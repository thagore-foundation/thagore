...
NAIVE_SRC = ROOT / "examples" / "intent_real_sumsq_naive.tg"
INTENT_SRC = ROOT / "examples" / "intent_real_sumsq_intent.tg"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark sum-squares intent rewrite")
...
def main() -> int:
    ...
    naive_exe = ROOT / "intent_real_sumsq_naive.exe"
    intent_exe = ROOT / "intent_real_sumsq_intent.exe"
    ...
    print("=== SumSquares Intent Benchmark ===")
    print("unit: seconds")
    print("")
