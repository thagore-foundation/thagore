...
python scripts\stage_guard.py --timeout 180 -- legacy\stage0.exe build src\thg.tg -o stage1.exe
if errorlevel 1 (
...
python scripts\stage_guard.py --timeout 240 -- .\stage1.exe src\thg.tg --build
if errorlevel 1 (
...
python scripts\stage_guard.py --timeout 120 -- .\thg_stage2.exe test_pure_v.tg --build
if errorlevel 1 (
