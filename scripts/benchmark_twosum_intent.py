...
NAIVE_SRC = ROOT / "examples" / "intent_real_two_sum_naive.tg"
INTENT_SRC = ROOT / "examples" / "intent_real_two_sum_intent.tg"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark two-sum intent rewrite")
...
def main() -> int:
    ...
    naive_exe = ROOT / "intent_real_two_sum_naive.exe"
    intent_exe = ROOT / "intent_real_two_sum_intent.exe"
